"""
Django settings for ovne project.
...
WSGI_APPLICATION = 'ovne.wsgi.application'
...
STATICFILES_DIRS = [
    os.parent.join(BASE_DIR, 'staticfiles'),
...
FILE_UPLOAD_MAX_MEMORY_SIZE = 250000000
